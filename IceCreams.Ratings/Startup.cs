...
namespace IceCreams.Ratings
{
    public class Startup : FunctionsStartup
    {
        ...
        private async Task<IEnumerable<KeyValuePair<string, string>>> GetCosmosDb(IConfigurationRoot config)
        {
            ...
            res.Add(new KeyValuePair<string, string>("Values:CosmosDBConnection", $"AccountEndpoint=https://{cosmosDbAccount}.documents.azure.com:443/;AccountKey={keys.primaryMasterKey};"));
            return res;
        }
